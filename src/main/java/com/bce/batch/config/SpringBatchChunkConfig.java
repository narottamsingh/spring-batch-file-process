...
//        reader.setResource(new FileSystemResource("/home/narottam/project/springboot/springbatch/spring-boot-batch/src/main/resources/data.txt")); // Change the file name as needed
//
